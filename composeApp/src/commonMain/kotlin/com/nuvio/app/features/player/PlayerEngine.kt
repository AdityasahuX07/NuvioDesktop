...
enum class PlayerControlsAction {
    ...
    KeyboardToggleSubtitle,
    KeyboardSequentialAudio,
    KeyboardSkipIntro,
    KeyboardNextEpisode,
    KeyboardSpeedUp,
    KeyboardSpeedDown,
    KeyboardSpeedReset,
    KeyboardSubtitleDelayDecrease,
    KeyboardSubtitleDelayIncrease,
    KeyboardToggleMute,
    KeyboardSubtitleOpacityToggle,
    KeyboardSubtitleOpacityIncrease,
    KeyboardSubtitleOpacityDecrease,
    KeyboardActivateHoldToSpeed,
    KeyboardDeactivateHoldToSpeed,
}
